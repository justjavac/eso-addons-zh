...
SafeAddString(PCHAT_DELZONETAGSTT                    ,"在消息开始处移除例如 说, 大喊 等标签",1)

SafeAddString(PCHAT_ZONETAGSAY                       ,"说",1)
SafeAddString(PCHAT_ZONETAGYELL                      ,"大喊",1)
...
SafeAddString(PCHAT_ENABLEPARTYSWITCHPORTTODUNGEON   ,"自动切换：副本/重载界面",1)
SafeAddString(PCHAT_ENABLEPARTYSWITCHPORTTODUNGEONTT ,"如你传送进入副本/执行重载界面/登录且已经在队伍中等情况下，上面提到的自动切换也会将频道切换为 /party。\n此设置仅当组队切换开启时生效!",1)
...
SafeAddString(PCHAT_YELL                             ,"大喊 - 名称",1)
SafeAddString(PCHAT_YELLTT                           ,"为 大喊 频道设置玩家名称颜色",1)

SafeAddString(PCHAT_YELLCHAT                         ,"大喊 - 信息",1)
SafeAddString(PCHAT_YELLCHATTT                       ,"为 大喊 频道设置聊天信息颜色",1)
...
SafeAddString(PCHAT_NPCYELL                          ,"NPC 大喊 - 名称",1)
SafeAddString(PCHAT_NPCYELLTT                        ,"为NPC 大喊 设置NPC名称颜色",1)

SafeAddString(PCHAT_NPCYELLCHAT                      ,"NPC 大喊 - 消息",1)
SafeAddString(PCHAT_NPCYELLCHATTT                    ,"为NPC 大喊 设置NPC聊天消息颜色",1)
